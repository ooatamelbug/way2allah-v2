   ...
   data-freq="{{ $channel->freq }}">
    ...
    <span class="w2a-channel-body">
        ...
        <span class="w2a-channel-specs">
            ...
            <span class="w2a-channel-spec-item">
                <span class="w2a-channel-spec-label"><i class="fa fa-tachometer" aria-hidden="true"></i> معدل الترميز:</span>
                <span class="w2a-channel-spec-val">{{ $channel->srate ?: '27500' }}</span>
            </span>
            <span class="w2a-channel-spec-item">
                <span class="w2a-channel-spec-label"><i class="fa fa-shield" aria-hidden="true"></i> معامل التصويب:</span>
