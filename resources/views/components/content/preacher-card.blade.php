@props(['author', 'href', 'count', 'countLabel'])
...
<a href="{{ $href }}" class="w2a-preacher-card" data-name="{{ $displayName }}">
    <span class="w2a-preacher-avatar-wrap">
        <img class="w2a-preacher-avatar" src="{{ $author->displayImageUrl() }}" alt="صورة {{ $displayName }}"
    ...
    <i class="fa fa-angle-right w2a-preacher-arrow" aria-hidden="true"></i>
</a>
