...
<div class="w2a-anasheed-wrap">
    <div class="w2a-reciters-toolbar">
        <div class="w2a-reciters-search-wrap">
            ...
            <input type="search" id="w2a_anasheed_search_input" class="w2a-reciters-search-input"
                placeholder="ابحث في مقاطع ومواد السلسلة..." autocomplete="off">
            <button type="button" id="w2a_anasheed_search_clear" class="w2a-reciters-search-clear" hidden
                aria-label="مسح البحث"><i class="fa fa-times" aria-hidden="true"></i></button>
        </div>
        <div class="w2a-tree-badge"><i class="fa fa-video-camera" aria-hidden="true"></i> {{ $items->count() }} مقطع
            متاح</div>
    </div>
        ...
        @forelse($items as $item)
            ...
            <a href="/var-item-{{ $item->id }}.htm" class="w2a-media-item-card" data-title="{{ $item->title }}">
                ...
                <span class="w2a-media-item-body">
                    ...
                    <span class="w2a-media-item-cta"><span>مشاهدة / استماع</span><i class="fa fa-angle-right"
