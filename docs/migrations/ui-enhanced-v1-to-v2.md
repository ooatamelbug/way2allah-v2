...
| 15 | `128cb5a0a4307505c704778a5ea67edddb691c14` | pending | Blade component adaptation | Added a shared group/series card grid across preacher, group, and channel listings. Preserved route targets, counts, and contextual author/channel labels without nested anchors; removed DataTables from the now table-free group page. |
